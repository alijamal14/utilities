...
function Utils() {
    this.Version = '12.1',
        ...
        },this.ToDateTimeFormat = function (Value) {
            return new Date(parseInt(Value.replace("/Date(", "").replace(")/", ""), 10))
        },
        function formatJSDate(jsDate, format) {
            // Check if Luxon is included
            if (typeof luxon === 'undefined') {
                throw new Error('Luxon library is not included.');
            }

            // Convert JavaScript Date to Luxon DateTime and format it
            return luxon.DateTime.fromJSDate(jsDate).toFormat(format);
        },
        ...
        //Make a function to generate a new GUID
    ...
    function formatDateString(dateString) {
        ...
        var dt = luxon.DateTime.fromMillis(timestamp);
        return dt.toFormat('yyyy-LLL-dd');
    },
}
